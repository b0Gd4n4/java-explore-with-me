...
public class AdmEventController {
    ...
    public List<EventDto> getEventsByAdmin(@RequestParam(required = false, name = "users") List<Long> users,
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public EventDto updateEventByAdmin(@Valid @RequestBody EventUpdateDto eventUpdateDto,
